...
<div class="flex h-full items-center justify-center bg-white p-4">
	<div class="w-full max-w-md rounded-lg border border-gray-200 bg-white p-8 shadow-sm">
		...
		<div class="mb-6 flex justify-center">
			<svg class="h-6 w-24" viewBox="0 0 272 92">
				<path
					fill="#4285F4"
		...
		<div class="space-y-2">
			<button
				class="flex w-full items-center gap-4 rounded-lg border border-gray-200 p-4 text-left hover:bg-gray-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
			>
				<div
					class="flex h-10 w-10 items-center justify-center rounded-full bg-emerald-500 text-lg font-medium text-white"
				>
					A
				</div>
				<div class="flex-1">
					<div class="font-medium text-gray-900">Alice Smith</div>
					<div class="text-sm text-gray-500">alice@contoso.com</div>
				</div>
			</button>
			...
			>
				...
				<div class="font-medium text-gray-700">Use another account</div>
			</button>
		</div>
